    ...
    <div class="modal-content">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::file('image', ['id' => 'quick_upload_image', 'accept' => 'image/*', 'class' => 'upload-element']) !!}
                        <small>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('product_custom_field1', null, [
                            'class' => 'form-control',
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('product_custom_field2', null, [
                            'class' => 'form-control',
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('product_custom_field3', null, [
                            'class' => 'form-control',
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('product_custom_field4', null, [
                            'class' => 'form-control',
        ...
        <div class="modal-footer">
            <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white"
                id="submit_quick_product">@lang('messages.save')</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        // Initialize file input for product image
        $('#quick_upload_image').fileinput(img_fileinput_setting);
